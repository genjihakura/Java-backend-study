package vn.vti.dtn2501.mall.config.openapi;
...
@OpenAPIDefinition(
    info = @Info(
        title = "VMall Mall Service API - phat title",
        description = "VMall Mall Service API documentation - phat description",
        version = "1.0 - phat version"
    ),
